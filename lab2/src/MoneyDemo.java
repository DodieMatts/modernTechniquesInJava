...
public class MoneyDemo
{
    public static void main(String[] args)
    {
        ...
        System.out.println("After adding " + SECOND_AMOUNT +
                " the total becomes " + balance.toString());

        // Subtract the third amount from the balance
        // and display the results.
        balance = balance.subtract(THIRD_AMOUNT);
        System.out.println("After subtracting " + THIRD_AMOUNT +
                " the total isgives " + balance.toString());
